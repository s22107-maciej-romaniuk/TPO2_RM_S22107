...
public class ProxyJob implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            } catch (zad1.Common.CustomException e) {
                e.printStackTrace();
    ...
    private void actBasedOnMessage() throws IOException, zad1.Common.CustomException {
        if (initialMessage.equals(zad1.Common.Constants.TRANSLATION_SERVER_REGISTRATION)) {
    ...
    private void passToTranslator(String requestString) throws IOException, zad1.Common.CustomException {
        ...
        if(!addressBook.containsKey(languageCode)) throw new zad1.Common.CustomException("Unknown language key");
        ...
        if(!response.equals("OK")) throw new zad1.Common.CustomException(response);
    }
}
